...
There are two ways you can run the tests, either using VCR mocked responses or by hitting the test site.  To run the tests with the DNSimple test site the file should include:
