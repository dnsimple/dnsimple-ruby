module Dnsimple
  class Client
    module ZonesRecords
      ...
      #
      # @see https://developer.dnsimple.com/v2/zones/records/#distribution
      #
      # @example Get record 123 in zone "example.com"
      #   client.zones.record_distribution(1010, "example.com", 123)
      #
      # @param  [Integer] account_id the account ID
      # @param  [String] zone_id the zone name
      # @param  [Integer] record_id the record ID
      ...
      # @raise  [Dnsimple::NotFoundError]
      # @raise  [Dnsimple::RequestError]
      def record_distribution(account_id, zone_id, record_id, options = {})
