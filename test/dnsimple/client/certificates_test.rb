...
describe Dnsimple::Client, ".certificates" do
  ...
  let(:subject) { Dnsimple::Client.new(base_url: "https://api.dnsimple.test", access_token: "a1b2c3").certificates }
  ...
  describe "#certificates" do
    ...
    it "returns the certificates" do
      ...
      response.data.each do |result|
        _(result).must_be_kind_of(Dnsimple::Struct::Certificate)
  ...
  describe "#purchase_letsencrypt_certificate" do
    ...
    it "returns the certificate purchase" do
      ...
      result = response.data
      _(result).must_be_kind_of(Dnsimple::Struct::CertificatePurchase)

      _(result.id).must_equal(101967)
      _(result.certificate_id).must_equal(101967)
  ...
  describe "#issue_letsencrypt_certificate" do
    ...
    it "returns the certificate" do
      ...
      _(result.alternate_names).must_equal([])
      _(result.years).must_equal(1)
      _(result.csr).must_be_nil
      _(result.state).must_equal("requesting")
      _(result.authority_identifier).must_equal("letsencrypt")
      _(result.auto_renew).must_equal(false)
    end
  ...
  describe "#purchase_letsencrypt_certificate_renewal" do
    ...
    it "returns the certificate renew" do
      ...
      result = response.data
      _(result).must_be_kind_of(Dnsimple::Struct::CertificateRenewal)

      _(result.id).must_equal(65082)
      _(result.old_certificate_id).must_equal(certificate_id)
      _(result.new_certificate_id).must_equal(101972)
      _(result.state).must_equal("new")
    end
